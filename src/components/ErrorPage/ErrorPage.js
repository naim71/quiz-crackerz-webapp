...
const ErrorPage = () => {
    return (
        <div>
            ...
            <Link to='/home' className="inline-flex text-white hover:bg-green-400 bg-sky-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900 my-4">Back to Homepage</Link>
            </div>
